...
// Glassmorphism: translucent surfaces with blur and soft borders.
const glass: ButtonThemeClasses = {
  base: "rounded-xl border transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 disabled:hover:translate-y-0",
  variants: {
    primary:
...
const neumorphism: ButtonThemeClasses = {
  base: "rounded-xl border-0 transition-all duration-200",
  variants: {
    primary:
...
const material: ButtonThemeClasses = {
  base: "rounded-md border-0 transition-all duration-150 uppercase text-sm tracking-wide",
  variants: {
    primary:
...
const cupertino: ButtonThemeClasses = {
  base: "rounded-xl border transition-all duration-150 font-semibold",
  variants: {
    primary:
...
const cyberpunk: ButtonThemeClasses = {
  base: "rounded-sm border font-mono uppercase tracking-widest text-xs transition-all duration-150",
  variants: {
    primary:
...
export const buttonThemeClasses: Record<UiTheme, ButtonThemeClasses> = {
  glass,
  neumorphism,
  material,
  cupertino,
